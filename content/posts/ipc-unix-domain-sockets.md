...
In the previous article, We discussed the [Named Pipes](/posts/ipc-named-pipes) mechanism to achieve Inter-Process Communications. This article will cover another one called Unix Domain Sockets.
...
The next article will discuss an old and very limited IPC mechanism called [Signal](/posts/ipc-unix-signals). Till then, take care of yourself and stay hydrated! ✌🏾