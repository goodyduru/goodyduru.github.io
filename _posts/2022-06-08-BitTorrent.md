...
* ip: The ip address of your client. If you choose to be solely a leecher, you set this to 0. Most trackers ignore this though because they can determine this from the ip address your HTTP request is coming from. 
...
Setting this parameter to 0 ensures the peers list is returned as a bencoded dictionary.  
Many trackers prefer requests with this set to 1 in order to save bandwidth.  
